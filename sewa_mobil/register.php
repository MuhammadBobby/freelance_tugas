                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-bolder text-info text-gradient">Halo</h3>
                                    <p class="mb-0">Masukkan data data yang dibutuhkan.</p>
                                </div>
                                <div class="card-body">
                                    <form action="" method="post">
                                        <label class="text-lg">Username / NIK</label>
                                        <div class="mb-3">
                                            <input type="text" name="nik" class="form-control" placeholder="Masukkan Username" />
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" name="register" class="btn bg-gradient-info w-100 mt-4 mb-0">Register</button>
                                        </div>
                                    </form>
                                </div>
