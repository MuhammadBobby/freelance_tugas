...
$nik = $_GET["nik"];
// query data pelanggan berdasarka nik
                ...
                <?php while ($mobil = $hasil->fetch_assoc()) : ?>
                    <form action="" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nik" class="form-control form-control-lg" value="<?= $mobil['nik'] ?>" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="text-lg">Nama</label>
                            <input type="text" name="nama" class="form-control form-control-lg" value="<?= $mobil['nama_pelanggan'] ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="alamat" class="text-lg">Alamat</label>
                            <input type="text" name="alamat" class="form-control form-control-lg" value="<?= $mobil['alamat'] ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="no_hp" class="text-lg">Nomor HP</label>
                            <input type="text" name="no_hp" class="form-control form-control-lg" value="<?= $mobil['no_hp'] ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="kode_unik" class="text-lg">Kode Unik</label>
                            <input type="text" name="kode_unik" class="form-control form-control-lg" value="<?= $mobil['kode_unik'] ?>" required>
                        </div>

                        <div class="text-center">
                            <button type="submit" name="ubah" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Update Data</button>
                        </div>
                        <p class="text-sm mt-3 mb-0">Tidak ingin Mengubah data? <a href="../pelanggan.php" class="text-dark font-weight-bolder">kembali</a></p>
                    </form>
                <?php endwhile; ?>
            </div>
        </div>
