...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO transaksi VALUES ('$id', '$penyewa', '$kamar', '$tanggal', '$harga' )";

    $updatekamar = "UPDATE kamar_kost SET status = 'disewa'
        WHERE id_kamar = '$kamar'";

    if ($conn->query($query) === TRUE && $conn->query($updatekamar) === TRUE) {
            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="id" style="border: 2px solid gray;" class="form-control form-control-lg" placeholder="ID Transaksi" required autocomplete="off">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal" style="border: 2px solid gray;" class="form-control form-control-lg" placeholder="Tanggal mulai sewa / bayar">
                    </div>
