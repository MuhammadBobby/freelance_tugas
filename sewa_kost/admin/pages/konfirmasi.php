...
// read
$query = "SELECT * FROM konfirmasi, penyewa WHERE konfirmasi.id_penyewa = penyewa.nik";
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="konfirmasi.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Table Konfirmasi Pesanan</h6>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm"><?= $kost['id_kamar'] ?></td>
                                                <td class="align-middle text-center text-sm"><?= $kost['tanggal_pembayaran'] ?></td>
                                                <td class="align-middle text-center text-sm text-warning">Rp. <?= $kost['jumlah_bayar'] ?></td>
                                                <td class="align-middle text-center text-sm text-danger"><?= $kost['desk'] ?></td>

                                                <?php if ($kost['desk'] == 'belum dikonfirmasi') : ?>
                                                    <td class="align-middle">
                                                        <a href="functions/konfirmasipesan.php?id=<?= $kost['id_transaksi'] ?>" class="bg-gradient-success rounded-pill" style="padding: 5px;" onclick=" return confirm ('Apakah Anda Yakin Ingin Mengonfirmasi data Ini ?');">konfirmasi</a>
                                                    </td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endwhile;
