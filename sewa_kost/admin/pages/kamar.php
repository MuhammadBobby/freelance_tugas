...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="kamar.php">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kamar Kost</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Kamar Kost</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="mb-5">
          <a href="functions/tambahkamar.php" class="p-3 rounded-2 bg-gradient-primary text-white text-bold">Tambah Data Kamar</a>
        </div>
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Table Kamar Kost</h6>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm text-bold"><?= $kost['id_kamar'] ?></td>
                        <td class="align-middle text-center text-sm">Rp. <?= $kost['harga_sewa'] ?></td>
                        <td class="align-middle text-center text-sm"><?= $kost['fasilitas'] ?></td>
                        <td class="align-middle text-center text-sm text-warning"><?= $kost['status'] ?></td>
                        <td class="align-middle">
                          <a href="functions/editkamar.php?id=<?= $kost['id_kamar'] ?>"><i class="material-icons">edit</i></a>
                          <a href="functions/hapuskamar.php?id=<?= $kost['id_kamar'] ?>"><i class=" material-icons" onclick=" return confirm ('Apakah Anda Yakin Ingin Menghapus data Ini ?');">delete</i></a>
                        </td>
                      </tr>
                    <?php endwhile;
                    ?>
