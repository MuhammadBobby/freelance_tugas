  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <h3 class="font-weight-bolder mb-0">Data Member</h3>
      </div>
    </nav>
    <!-- End Navbar -->
    <!-- Content -->
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-lg-6">
          <a class="btn btn-primary" href="tambahdatamember.php">Tambah Data Member</a>
        </div>
      </div>
      <!-- Table -->
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            // Query to fetch data from tbl_member
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                ...
                echo "<td style='text-align: center;'>" . $row['alamat_pelanggan'] . "</td>";
                echo "<td style='text-align: center;'>" . $row['telepon_pelanggan'] . "</td>";
                echo "</tr>";
              }
            } else {
              echo "<tr><td colspan='4'>Tidak ada data member.</td></tr>";
            }
