...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        <div class="col-lg-6">
          <a class="btn btn-primary" href="tambahdatatransaksi.php">Tambah Data Transaksi</a>
        </div>
      </div>
      <!-- Akhir Button -->
      ...
      <div class="table-responsive">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            // Query to fetch data from tbl_transaksi
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td style='text-align: center;'>" . $row['id_transaksi'] . "</td>";
                echo "<td  style='text-align: center;'>" . $row['id_meja'] . "</td>";
                echo "<td  style='text-align: center;'>" . $row['id_pelanggan'] . "</td>";
                echo "<td  style='text-align: center;'>" . $row['waktu_mulai'] . "</td>";
                echo "<td  style='text-align: center;'>" . $row['waktu_selesai'] . "</td>";
                echo "<td  style='text-align: center;'>" . $row['total_harga'] . "</td>";
