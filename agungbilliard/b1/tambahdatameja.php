...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <!-- End Navbar -->
        <!-- Form untuk input data meja -->
        <form action="simpandatameja.php" method="post">
            <!-- <label for="id_meja">ID Meja:</label><br> -->

            <label for="nama_meja">nama meja:</label><br>
            <input type="text" name="nama_meja" required><br>


            <label for="status_meja">Status Meja:</label><br>
            <select name="status_meja" required><br>
                <option value="booking">Booking</option>
                <option value="belum booking">Belum Booking</option>
            </select><br><br>

            <button type="submit">Tambah Data Meja</button>
        </form>
    </main>
    <!--   Core JS Files   -->
