                                        ...
                                        <?php while ($row = $hasil->fetch_assoc()) { ?>
                                            <form action="updatesupplier.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="id" class="form-control" value="<?= $row['id_supplier']; ?>" readonly>

                                                    <label for="nama">Nama Supplier</label>
                                                    <input type="text" name="nama" class="form-control" value="<?= $row['nama_supplier']; ?>" required>

                                                    <label for="alamat">Alamat Supplier</label>
                                                    <input type="text" name="alamat" class="form-control" value="<?= $row['alamat_supplier']; ?>" required>

                                                    <label for="telp">Telepon Supplier</label>
                                                    <input type="text" name="telp" class="form-control" value="<?= $row['telepon_supplier']; ?>" required>
