                                    ...
                                    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                                        ...
                                        <form action="simpansupplier.php" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="id" class="form-control" placeholder="Masukan ID Supplier" required>

                                                <label for="nama">Nama Supplier</label>
                                                <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Supplier" required>

                                                <label for="alamat">Alamat Supplier</label>
                                                <input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Supplier" required>

                                                <label for="telp">Telepon Supplier</label>
                                                <input type="text" name="telp" class="form-control" placeholder="Masukan Telepon Supplier" required>
