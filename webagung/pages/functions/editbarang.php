...
$id = $_GET['id'];
$sql = "SELECT * FROM barang, supplier WHERE barang_id='$id' AND barang.supplier = supplier.id_supplier";
                                        ...
                                        <?php while ($row = $hasil->fetch_assoc()) { ?>
                                            <form action="updatebarang.php" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="id" class="form-control" value="<?= $row['barang_id']; ?>" readonly>
                                                    ...
                                                    <input type="number" name="stok" class="form-control" value="<?= $row['stok_barang']; ?>" required>

                                                    <label for="supplier">Supplier</label>
                                                    <select name="supplier" id="supplier" class="form-control form-control-lg" required>
                                                        <option selected value="<?= $row['supplier']; ?>"><?= $row['nama_supplier']; ?></option>
