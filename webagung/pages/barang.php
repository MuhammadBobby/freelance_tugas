...
$sql = "SELECT * FROM barang, supplier WHERE barang.supplier = supplier.id_supplier";
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-11 col-sm-offset-5 col-md-12 col-md-offset-2 main">
                        ...
                        if (isset($_GET['sukses']) == 'sukses') {
                            echo '<h2 class="alert alert-success">Berhasil Menyimpan Data Barang</h2>';
                        } elseif (isset($_GET['hapus']) == 'hapus') {
                            echo '<h2 class="alert alert-success">Berhasil Menghapus Data Barang</h2>';
                        } else {
                        }
                        ?>
                        <h1 class="sub-header">
                            <a class="btn btn-lg btn-primary" href="functions/tambahbarang.php">Tambah Data Barang</a>
                        </h1>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-primary" href="functions/editbarang.php?id=<?php echo $row["barang_id"]; ?>">Edit</a>
                                                                    <a class="btn btn-danger" href="functions/hapusbarang.php?id=<?php echo $row["barang_id"]; ?>">Hapus</a>
                                                                </td>
                                                            </tr>
                                                        <?php
                                                        } ?>
