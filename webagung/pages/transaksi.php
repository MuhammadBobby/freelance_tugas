...
$sql = "SELECT * FROM barang_masuk, barang_masuk_detail, barang, supplier WHERE
        ...
        ORDER BY barang_masuk.tanggal_masuk";
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-sm-11 col-sm-offset-5 col-md-12 col-md-offset-2 main">
                        <h1 class="page-header">Data Transaksi Barang Masuk</h1>
                        <?php
                        if (isset($_GET['sukses']) == 'sukses') {
                            echo '<h2 class="alert alert-success">Berhasil Menyimpan Data Transaksi Barang Masuk</h2>';
                        } elseif (isset($_GET['hapus']) == 'hapus') {
                            echo '<h2 class="alert alert-success">Berhasil Menghapus Data Transaksi Barang Masuk</h2>';
                        } else {
                        }
                        ?>
                        <h1 class="sub-header">
                            <a class="btn btn-lg btn-primary" href="functions/tambahtransaksi.php">Tambah Data Transaksi Barang Masuk</a>
                        </h1>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-primary" href="functions/edittransaksi.php?id=<?php echo $row["detail_id"]; ?>">Edit</a>
                                                                    <a class="btn btn-danger" href="functions/hapustransaksi.php?id=<?php echo $row["detail_id"]; ?>&masuk=<?php echo $row["masuk_id"]; ?>&barang=<?php echo $row["barang_id"]; ?>">Hapus</a>
                                                                </td>
                                                            </tr>
                                                        <?php
                                                        } ?>
